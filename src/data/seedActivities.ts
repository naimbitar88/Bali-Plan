...
const RAW: Activity[] = [
  ...
  },
  {
    ...
    category: 'afterparty',
    defaultDurationMin: 240,
    instagram: ig('akademibali'),
    verifyNote: 'Acclaimed craft-cocktail bar at Desa Potato Head, Petitenget (late, not till dawn).',
  },
  {
    id: 'ap-jenja',
    name: 'Jenja Club',
